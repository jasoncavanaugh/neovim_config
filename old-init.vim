...
inoremap {<S-CR> {<CR>}<Esc>ko
inoremap {<CR> {<CR>}<Esc>ko
" 1/6/22 - I don't know if I'll actually use these
noremap <C-k> <C-u>
noremap <C-j> <C-d>
...
" Maximize window on open. Copied from the web. 
...
" EXAMPLE COC FILE THING THAT I JUST COPIED OFF OF THE README FROM
" GITHUB
"
